...
syn match zoteroKey /@[A-Z0-9]*/ containedin=pandocPCite,pandocICite conceal
...
syn match pandocPCite /\[[^]]*@[A-Z0-9]*#[^]]*\]/ contains=pandocEmphasis,pandocStrong,pandocLatex,pandocCiteKey,@Spell,pandocAmpersandEscape
syn match pandocICite /-*@[A-Z0-9]*#[[:alnum:]à-öø-ÿÀ-ÖØ-ß_:\-]/ contains=zoteroKey,pandocCiteKey,@Spell display
